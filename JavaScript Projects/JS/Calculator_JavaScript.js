...
function Input_Digit(digit) {
    ...
    //here checking to see if Wait_Second_Operand is true and set
...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        // here saying that if the Display_Value does not contain a decimal point
...
function Handle_Operator(Next_Operator) {
    ...
    //displayed pn the screen to a number and then store the result in
...
//here resets the calculator back to null after computation
