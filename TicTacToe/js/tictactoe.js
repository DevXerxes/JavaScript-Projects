...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        c.lineWidth = 10;
        //This method sets color of line.
        c.strokeStyle = 'rgba(70, 255, 33, .8)';
        //This method draws everything laid out above.
        c.stroke();
        //This condition checks if reached the endpoint.
        if (x1 <= x2 && y1 <= y2) {
    ...
    //This line doesnt allow clicking while the win sound is playing.
    disableClick();
    //This line plays the win sounds.
    audio('./media/synthwin.mp3');
...
function resetGame() {
    ...
    //This resets the array so it's empty and can start over.
    selectedSquares = [];
}